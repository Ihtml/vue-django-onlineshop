  ...
  <div id="main">
    ...
    <div class="cart-box" id="cart-box">
      ...
      <div class="goods-list">
        <ul>
          <li class="cle hover" style="border-bottom-style: none;" v-for="(item,index) in goods.goods_list" :key=item.id>
            <div class="pic">
        ...
        <div class="extr">
          <div class="address">
            ...
            <ul>
              ...
              <li v-for="item in addrInfo" :key="item" :class="{'addressActive':addressActive==item.id}" @click="selectAddr(item.id)">
          ...
          <div class="pay">
            ...
            <p class="payWrap"><img v-for="item in payWrapList" :key="item" src="../../static/images/alipay.jpg" :class="{'payWrapActive':payWrapActive==item.id}" @click="selectPay(item.id)"></p>
          </div>
        </div>
